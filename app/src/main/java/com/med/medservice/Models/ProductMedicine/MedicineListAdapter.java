...
public class MedicineListAdapter extends RecyclerView.Adapter<MedicineListAdapter.MedicineHolder> {
    ...
    public MedicineListAdapter(ArrayList<MedicineList> list, Context context, UpdateCartInterface cartUpdateContext) {
        this.list = list;
    ...
    public MedicineListAdapter(ArrayList<MedicineList> list, Context context) {
        this.list = list;
        this.context = context;

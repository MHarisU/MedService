...
public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.CategoryHolder> {
    ...
    public SubCategoryAdapter(ArrayList<SubCategoryList> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull CategoryHolder holder, int position) {
        ...
        final SubCategoryList currentData = list.get(position);

        String category_name = currentData.getSub_category_name();

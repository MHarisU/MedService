...
public class DoctorRegisterActivity extends AppCompatActivity {
    ...
    EditText editText_username, editText_first, editText_last, editText_email, editText_phone, editText_address, editText_nip, editText_upin, editText_password;
...
//        stateNames[4] = "Colorado";
    ...
    private void Register(final String first, final String last, final String DOB, final String email, final String phone,
                          final String address, final String npi, final String upin,
                          final String state, final String spec, final String password) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_Register,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Log.d("reg_response", "Error: "+error.toString());
    ...
    public void SelectDateTime(View view) {
        ...
        new DatePickerDialog(DoctorRegisterActivity.this, AlertDialog.THEME_HOLO_LIGHT, dateSetListener, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();

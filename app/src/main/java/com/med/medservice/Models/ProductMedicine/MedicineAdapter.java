...
public class MedicineAdapter extends RecyclerView.Adapter<MedicineAdapter.MedicineHolder> {
    ...
    public MedicineAdapter(ArrayList<MedicineList> list, Context context) {
        this.list = list;
    ...
    public MedicineAdapter(ArrayList<MedicineList> list, Context context, UpdateCartInterface cartUpdateContext) {
        this.list = list;
        this.context = context;
    ...
    public MedicineHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(context).inflate(R.layout.medicine_row, parent, false);

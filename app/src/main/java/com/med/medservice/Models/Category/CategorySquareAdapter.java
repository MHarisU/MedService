...
public class CategorySquareAdapter extends RecyclerView.Adapter<CategorySquareAdapter.CategoryHolder> {
    ...
    public CategorySquareAdapter(ArrayList<CategoryList> list, Context context) {
        this.list = list;
    ...
    public CategoryHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(context).inflate(R.layout.category_square_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull CategoryHolder holder, int position) {
     ...
     //   holder.category_image_view.setBackgroundColor(currentColor);
        ...
        holder.category_name_view.setBackground(draw); //textview

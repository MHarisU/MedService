...
public class PatientRegisterActivity extends AppCompatActivity {
    ...
    LinearLayout layoutPatientRepresentative, accountDetailsLayout, personalDetailsLayout, medicalDetailsLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicalDetailsLayout = findViewById(R.id.medicalDetailsLayout);
...
//        stateNames[4] = "Colorado";
    ...
    public void continuePersonalDetail(View view) {
        ...
        medicalDetailsLayout.setVisibility(View.VISIBLE);
        personalDetailsLayout.setVisibility(View.GONE);
    }

    public void backToPersonalDetail(View view) {

        medicalDetailsLayout.setVisibility(View.GONE);
        personalDetailsLayout.setVisibility(View.VISIBLE);
    }
